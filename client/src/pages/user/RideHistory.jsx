...
import { FaHistory, FaMapMarkerAlt, FaCalendarAlt, FaCar, FaArrowLeft } from 'react-icons/fa';
    ...
    <div className="max-w-4xl mx-auto px-4 py-8 space-y-6">
      ...
      <div className="flex items-center space-x-3">
        ...
        <div>
          ...
          <p className="text-xs md:text-sm text-slate-400 font-medium">Review your historical bookings and coordinates</p>
        </div>
      </div>
      ...
      {loading ? (
        ...
        <div className="glass p-12 text-center rounded-2xl border border-white/5 shadow-xl space-y-4">
          ...
          <p className="text-slate-400 text-sm font-semibold">You don't have any booking history records.</p>
        </div>
      ) : (
                ...
                <div className="flex space-x-4 text-slate-400">
                  ...
                  {ride.driver_name && (
                    <span className="flex items-center space-x-1">
                      ...
                      <span><b>Driver:</b> {ride.driver_name}</span>
                    </span>
                  )}
                </div>
